...
<div class="card pad" style="display:flex;justify-content:space-between;align-items:center">
  <div>
    ...
    <div class="muted" style="font-size:12px;margin-top:4px">
      ...
      @isset($listing->views) • Views {{ $listing->views }} @endisset
      @isset($listing->wa_clicks) • WA {{ $listing->wa_clicks }} @endisset
    </div>
  </div>
  <div style="display:flex;gap:8px">
    <a class="btn primary" href="{{ route('listings.edit',['listing'=>$listing->id]) }}">Edit</a>
